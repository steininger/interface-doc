...
| `ftChargeItemCase`     | `Int64`               | 0<br />mandatory                            | Type of service or item according to the refer-ence table in the appendix. It is used in order to determine the processing logic for the cor-responding business transaction         | 0-          |
